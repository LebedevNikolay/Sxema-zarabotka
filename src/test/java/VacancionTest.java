...
public class VacancionTest {
    ...
    public void testCashVacancion(int expected, int income, int expenses, int threshold) {
        ...
        //int expenses = 3_000; // обязательные траты за месяц
        //int threshold = 20_000; // время на отдых
    ...
    //  expenses = 60_000; // обязательные траты за месяц
    //  int threshold = 150_000; // время на отдых
    //  int actual = service.calculate(income, expenses, threshold);
